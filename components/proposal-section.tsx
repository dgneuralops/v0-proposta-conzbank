        ...
        <div className="max-w-4xl mx-auto space-y-10">
          ...
          <Card className="p-6 md:p-8 glass border border-border hover:border-primary/30 transition-colors duration-300">
            ...
            <p className="font-inter text-muted-foreground text-pretty leading-relaxed text-lg">
              Montar e/ou operar uma estrutura completa de aquisição digital para consórcios voltados a brasileiros no exterior, com foco em escalar a geração de leads qualificados e maximizar o volume de crédito vendido mensalmente.
            </p>
          </Card>
          ...
          <Card className="p-6 md:p-8 glass border border-border hover:border-primary/30 transition-colors duration-300">
            ...
            <ul className="space-y-3 font-inter">
              {[
                "Estratégia completa de aquisição e planejamento de campanhas",
                "Copywriting para anúncios, páginas e cartas de vendas",
                "Criação e otimização de funis (captura, pages e nurturing)",
                "Implementação de CRM e automações de marketing e vendas",
                "Integração com WhatsApp e e-mail marketing",
                "Treinamento e documentação técnica (dependendo do modelo)",
                "Suporte estratégico por período determinado"
              ].map((item, i) => (
                <li 
                  key={i} 
          ...
          <div className="space-y-4 mt-8 text-center">
            ...
            <p className="text-muted-foreground font-inter">Escolha o modelo ideal para sua operação</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 fade-in mt-6">
            <InteractiveModelCard
              ...
              footerNote="Ideal para empresas com equipe interna que precisam de máquina pronta para escalar."
            ...
            <InteractiveModelCard
              ...
              extraNote="Mensalidade: R$ 5.100 · Comissão de êxito: 0,3% sobre crédito vendido dos leads"
              footerNote="Ideal para empresas que precisam de parceiro estratégico com acompanhamento ativo."
            ...
            <InteractiveModelCard
              ...
              subtitle="Automatize qualificação e follow-ups"
              ...
              items={["Configuração de IA de atendimento integrada ao WhatsApp e CRM","Qualificação automática de leads","Follow-up inteligente e redução de perda de oportunidades","Scripts prontos e treinados para consórcio","Suporte técnico"]}
            />
          </div>
          ...
          <Card className="p-6 md:p-8 glass border border-border hover:border-primary/30 transition-colors duration-300">
            ...
            <ul className="space-y-3 font-inter">
              {[
                "Experiência completa em estruturação de funis e campanhas de performance",
                "Alta especialização em copy, aquisição e vendas consultivas",
                "Modelo personalizado e flexível conforme a estrutura da empresa",
          ...
          <Card className="p-6 md:p-8 glass border border-border hover:border-primary/30 transition-colors duration-300">
            ...
            <ul className="space-y-3 font-inter">
              {[
                ...
                "Leads gerados serão atribuídos via parâmetros de rastreamento (UTM, CRM ou formulário específico)",
          ...
          <Card className="p-6 md:p-8 glass border border-border hover:border-primary/30 transition-colors duration-300">
            ...
            <ul className="space-y-3 font-inter">
              {[
                "Os valores não incluem gestão do time comercial do cliente. A atuação é focada em marketing, estrutura e estratégia.",
